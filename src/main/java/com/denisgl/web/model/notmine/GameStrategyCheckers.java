...
import com.denisgl.web.model.Checker;
import com.denisgl.web.model.CheckerSide;
import com.denisgl.web.model.Point;
import com.denisgl.web.model.notmine.Board.Square;
        ...
        if (square.equalsType(Square.NOT_VALID_COORDINATES)) {
            ...
            if (checker == null) {
                ...
                if (checker.isSide(CheckerSide.BLACK)) {
                    tmpcell = "b";
                } else if (checker.isSide(CheckerSide.WHITE)) {
                    tmpcell = "r";
                } else {
                    tmpcell = "error";
                }
